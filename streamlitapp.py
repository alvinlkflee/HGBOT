...
def main():
    ...
    with col1:
        st.image(thank_you, caption="thank you")
    with col2:
        st.image(hello, caption="hello")
    with col3:
        st.image(i_love_you, caption="iloveyou")
    with col4:
        st.image(pointer, caption="pointer")
...
def draw_info_text(image, brect, handedness, hand_sign_text,
    ...
    if finger_gesture_text != "":
        cv.putText(image, "Finger Gesture:" + finger_gesture_text, (10, 30),
